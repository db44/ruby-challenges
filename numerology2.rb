...
def birth_path
  ...
  number[2].to_i + number[3].to_i + 
  number[4].to_i + number[5].to_i + 
  number[6].to_i + number[7].to_i
...
def display_numerology_mumbo_jumbo(birth_path)
...
display_numerology_mumbo_jumbo(birth_path)